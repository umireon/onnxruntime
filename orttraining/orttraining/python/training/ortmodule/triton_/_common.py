...
NP_TYPE_TO_TENSOR_TYPE = {v: k for k, v in TENSOR_TYPE_TO_NP_TYPE.items() if k != onnx.TensorProto.BFLOAT16}
    ...
    def gen_name2module_map(self, infer_shape=True):
        ...
        for node in self.graph.node:
            ...
            for out in node.output:
                ...
                #    continue
                assert out not in self.produced_by, "multiple producers for node: %s" % out
